...
Vi behandler oplysningerne for at:

- **Levere Tjenesten** — sende relevante udbudsbeskeder. Retsgrundlag: opfyldelse af aftalen, databeskyttelsesforordningen art. 6, stk. 1, litra b.
- **Administrere abonnement, betaling og support** — art. 6, stk. 1, litra b og c (herunder bogføringspligt).
...
Vi sælger ikke dine oplysninger. Vi deler oplysninger med betroede databehandlere, der behandler data på vores vegne under databehandleraftaler: Supabase (database, Paris/EU), Vercel (hosting), SureSMS (SMS-udsendelse), Resend (e-mail) samt Frisbii, MobilePay og Clearhaus (betaling). Du kan se den fulde, aktuelle liste i dokumentet "Underdatabehandlere".
...
## Sikkerhed
Vi har truffet tekniske og organisatoriske foranstaltninger for at beskytte dine oplysninger mod uautoriseret adgang, tab og misbrug, herunder adgangsstyring, kryptering af kommunikation og hosting hos databehandlere i EU (vores database er placeret i Paris, Frankrig). Læs mere i dokumentet "Sikkerhed og drift".

## Ændringer
Vi kan opdatere denne privatlivspolitik. Den gældende version er altid tilgængelig på birdly.dk.
