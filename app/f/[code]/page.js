...
// Kort-link til feedback-skemaet: /f/{list_short_code} → /forlaeng/{list_token}
//
// HVORFOR EN EGEN KORT RUTE: det fulde list_token er 48 hex-tegn, så et direkte link
// fylder 79 tegn i en SMS. Dansk tekst tvinger UCS-2 (70 tegn pr. segment), og de 48
// tegn kostede dermed et helt ekstra segment på hver eneste besked. Kortkoden er 8 tegn.
//
// Genbruger resolve-short-code's EKSISTERENDE kind:"list"-opslag — ingen ny tabel,
// ingen ny kolonne, ingen ændring i Edge Function'en. Samme mønster som /u/[code].
...
export default async function Page({ params }) {
  ...
  if (token) redirect(`/forlaeng/${token}`);
