...
export const en = {
  ...
  funnel: {
    ...
    firma: {
      // §26's terminologi-liste, ordret. Etiketten ER overskriften: et felt der
      // hedder "Company number" behøver ikke også en sætning der spørger om det.
      label: "Company number",
      // ⚠️ FRA JONAS' BRIEF, ordret. Copy-filen §26 siger kun "Do not force
      // Companies House registration. Provide a suitable alternate path" —
      // altså HVAD der skal ske, ikke hvad der skal stå. Ordlyden er Jonas'.
      udenNummer: "Don't have a company number?",
      soleTrader: "Continue as a cleaning business",
      soleTraderTerm: "Sole trader",
    },

    omraade: {
      // §26, ordret. Etiketten er overskriften.
    ...
    kontakt: {
      // §26, ordret — inkl. at hjælpelinjen ikke har punktum i filen.
    ...
    betaling: {
      // §26, ordret. Bruges når checkout-trinnet bygges.
