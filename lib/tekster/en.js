...
import { TRIAL_DAYS } from "../pakke.js";
// ⚠️ PRØVELÆNGDEN ER ET VILKÅR, IKKE COPY (14-09-2026). Copy-filen skrev "14 days
// free" seks steder. Vilkåret ændrede sig til 7, og seks strenge i en ordbog er
// seks steder at glæmme. Tallet kommer nu fra lib/pakke.js — samme kilde som DK,
// fordi det er SAMME aftale. Alt andet i strengene står ordret som i copy-filen.
export const en = {
  hero: {
  ...
  bevis: {
    ...
    // ⚠️ SPROGET STYRER TAL- OG TIDSFORMAT, IKKE ORDLYD. Uden det skrev
    // bevis-bjaelken "1.291" (dansk tusindtalspunktum, som en brite laeser som
    // 1,291) og et klokkeslaet i KOEBENHAVNSK tid paa et britisk site. Det er
    // et tidsstempel der skal skabe tillid til at motoren koerer; staar det en
    // time forkert, goer det det modsatte. Se lib/opgaveTal.js.
    sprog: "en-GB",
  ...
  trust: [`${TRIAL_DAYS} days free`, "No portal", "No long-term lock-in", "Match Guarantee"],
  ...
  motoren: {
    ...
    trin: [
      ...
      },
      {
        ...
        tekst: "We find relevant public work and filter out the rest.",
      },
      {
        nr: "03",
  ...
  vaerdi: {
    ...
    lead: "Birdly finds relevant public cleaning work. You decide which contracts are worth going for.",
  ...
  funnel: {
    ...
    trust: `£0 today · ${TRIAL_DAYS} days free · No long-term lock-in`,
    ...
    // ⚠️ FIRE ETAPER, SOM DK (11-09-2026). DK's funnel har Virksomhed ·
    // Opgaver · Dine match · Start Birdly, og "Dine match" manglede her - det
    // var dét trin der gjorde de to funneler til to forskellige oplevelser.
    // "Your matches" hoerer til samme kategori som de tre oevrige etape-navne,
    // som Jonas godkendte 09-09-2026 som funktionel UI.
    etaper: ["Company", "Contracts", "Your matches", "Start Birdly"],
    // ── DK'S TRE TRUST-PUNKTER, ikke Trust-linjens tre. ──
    // ⚠️ DE ER IKKE DET SAMME. Copy-filens "Trust:"-linje er £0/prøvedage/lock-in
    // og hoerer under knappen. DK's punkter i venstre kolonne besvarer en anden
    // indvending: at det bliver besvaerligt. Begge staar paa DK's skaerm, og
    // begge staar nu her. Ordlyden er Jonas' brief 11-09-2026.
    punkter: ["No portal", "No daily searching", "No complicated setup"],

    // Info-kortet under argumentet. DK: "Offentlige opgaver er ogsaa for
    // mindre virksomheder." Ordlyd fra Jonas' brief 11-09-2026.
    smaa: {
      smaaOverskrift: "Public contracts are also for smaller businesses.",
      smaaBrod: "It doesn't have to be complicated. Birdly finds them. You choose which ones to go for.",
    },

    // Mini-ankeret: to kort der goer det foerste klik oekonomisk indlysende.
    // ⚠️ BELOEBENE ER STOERRELSESORDENER MED "can be" FORAN - ikke et konkret
    // udbud, og aldrig et tal vi har fundet paa. Samme forbehold som DK's.
    anker: {
      ankerVenstre: "A relevant contract",
      ankerKanVaere: "can be",
      ankerBeloeb: "£100,000 · £300,000 · or more",
      ankerHoejre: "Birdly for a full year",
    },

    // Stats-boksen. ⚠️ RENDERES KUN NAAR DER ER AEGTE GB-TAL (dataLever).
    // ⚠️ KUN OVERSKRIFTEN STAAR HER. Etiketterne under hvert tal genbruges fra
    // forsidens `bevis`-blok, som er ordret fra copy-filen. DK har to lidt
    // forskellige saet (forside og /start); UK faar eet, fordi filen kun har
    // eet - og at oversaette DK's andet saet ville vaere opfundet copy.
    bevis: {
      bevisKick: "Birdly is already watching",
    },

    // Form-kortets intro under overskriften.
    firmaIntro: "Enter your company number. Birdly will identify your business and start looking for relevant contracts.",

    // ── SKAERM A: BELOENNINGS-/BEVIS-SKAERMEN (Jonas' brief 13-09-2026) ──
    //
    // ⚠️ TALLET ER IKKE COPY. {N} kommer fra preview-kandidater - SELVE
    // match-reglen, samme kilde som DK's "42". Det er derfor delt i to: en
    // etiket her, og et tal fra motoren. Skriv aldrig et fast tal ind.
    //
    // ⚠️ INTET TAL ⇒ INGEN SKAERM. Jonas' regel 1: vis aldrig 0 og aldrig en
    // placeholder. Er tallet 0, eller er dataLever slukket, springes hele
    // skaermen over - kunden gaar direkte videre til spoergsmaalene.
    beloenning: {
      beloenningSuffix: "open contracts that match you",
      beloenningUnder: "These are the kind of contracts Birdly can keep an eye on for you.",
      beloenningVidere: "Let's make your matches even sharper",
    },

    // Match-trinnet. ⚠️ INGEN OPDIGTEDE MATCHES: indtil motoren leverer aegte
    // GB-data (markets.js: dataLever), staar den aerlige "vi leder"-tilstand.
    match: {
      // ⚠️ ENTYDIGT NOEGLENAVN MED VILJE. Undtagelseslisten i verify-uk-copy
      // slaar op paa det SIDSTE noeglesegment, saa en generisk `overskrift` her
      // ville fritage hver eneste overskrift i hele ordbogen - en bagdoer, ikke
      // en undtagelse.
      matchOverskrift: "We're looking for contracts that fit you.",
      leder: "Birdly is checking public contracts across England against what you've told us. You'll see your first matches by text and email.",
    },
  ...
  sms: {
    ...
    lead1: "Birdly automatically finds public work that fits your business.",
    ...
    // ⚠️ "Bid template where relevant" ER FJERNET (11-09-2026). Den modsagde
    // sidens egen FAQ tre sektioner laengere nede, som siger "Not yet. ... Bid
    // support is on the roadmap." Begrundelsen for FAQ-svaret staar allerede i
    // noten over `faq`: der findes ingen britisk bud-skabelon-rute. Punktet her
    // lovede altsaa en leverance i selve beskeden, som produktet ikke har - og
    // den af to modsigelser man fjerner, er den der lover for meget.
    punkter: ["Short summary", "Deadline", "Direct link"],
  ...
  priser: {
    ...
    ctaAar: `Start ${TRIAL_DAYS} days free`,
  ...
  risiko: {
    ...
    overskrift: `${TRIAL_DAYS} days free. No relevant matches? You don't pay.`,
    ...
    // lib/pakke.js; GB byggede det som een streng fra
    // copy-filens trust points, saa tallet ikke skal formateres to steder.
    proeveDage: `${TRIAL_DAYS} days free`,
  ...
  faq: {
    ...
    top: [
      {
        ...
        svar: "Birdly finds public-sector contracts from buyers such as councils, schools, academy trusts, housing associations, NHS bodies, government organisations and other public buyers.",
      },
      {
      ...
      {
        sp: `What happens after the ${TRIAL_DAYS}-day free trial?`,
    ...
    rest: [
      ...
      },
      {
        ...
        // actual UK ingestion frequency") og er ikke med som ordlyd — men det
        // er præcis den instruks der gør det her svar forkert i sin gamle form.
        //
        // ⚠️ RETTET 11-09-2026: "Usually as soon as Birdly processes a new
        // relevant notice" beskrev ikke motoren. Motoren er DEN SAMME for begge
        // markeder, og DK's egen FAQ siger hvad den gør: "Vi samler dagens
        // matchende opgaver i én besked, så du får overblik uden unødige
        // notifikationer" (lib/faq.js). Et britisk løfte om besked i samme
        // sekund ville altså være usandt i det øjeblik GB's motor tændes — og
        // ingen vagt ville fange det, for sætningen er grammatisk upåklagelig.
        //
        // ⚠️ JONAS' ANDEN SÆTNING ER UDELADT MED VILJE. Hans brief foreslår
        // "Time-sensitive private jobs may be sent separately." Private opgaver
        // har intet GB-flag og ingen britisk oprettelsesrute, så sætningen ville
        // beskrive en leverance der ikke kan ske. Den hører til den dag
        // funktionen findes for GB.
        svar: "We group your public contract matches into one daily message, so you get the opportunities without constant notifications.",
      },
      {
  ...
  // §3 HEADER-NAV og §27 FOOTER.
  //
  // ⚠️ PUNKTERNE PEGER PAA ANKRE PAA /uk, IKKE PAA ENGELSKE SIDER.
  // Copy-filen lister labels for begge ("How it works", "Pricing", "Why
  // Birdly", "FAQ", "About", "Guides", "For your trade", "Post a job",
  // "Public contracts for small firms", "Cancel"), men de fleste af SIDERNE
  // findes ikke paa engelsk. Et link til en 404 er vaerre end intet link, saa
  // kun de fire der har et ANKER paa den britiske forside er med.
  //
  // ⚠️ "For your trade" ER ALDRIG MED. Markedet er cleaning-only, og en
  // brancheoversigt ville love tyve fag vi ikke har.
  //
  // ⚠️ ANKRENE HEDDER STADIG NOGET DANSK (#hvordan, #priser, #problem).
  // Id'erne staar i Sektioner.js og deles med DK; markedsafhaengige id'er ville
  // vaere en aendring af dansk markup for britisk skyld. De er usynlige indtil
  // man klikker. Flagget til Jonas som selvstaendig polish.
  nav: {
    punkter: [
      { label: "How it works", href: "#hvordan" },
      { label: "Pricing", href: "#priser" },
      { label: "Why Birdly", href: "#problem" },
      { label: "FAQ", href: "#faq" },
    ],
  },

  footer: {
    // §27: "Brand/domain: Birdly" - UDEN ".dk". Logoet er en SVG med ".dk"
    // bagt ind, saa den britiske header og footer saetter ordmaerket som tekst
    // ved siden af fuglemaerket i stedet. Asset'et er Fase B; teksten er rigtig nu.
    brand: "Birdly",
    // ⚠️ DEN HER LINJE ER JURA, IKKE MARKETING - og den maa ALDRIG antyde
    // et britisk selskab. Copy-filen siger det selv: "Do not show the Danish
    // CVR/address blindly as if it is a UK company." Ordlyden er Jonas' og
    // jura-pakkens note 3, ordret.
    firma: "Birdly is operated by Birdly.dk, CVR no. 35764283, Denmark.",
    // §27 "Legal: Terms & Security". Linket peger paa /terms-hub'en, som
    // selv linker videre til de ni oevrige - praecis som den danske footer
    // har EET jura-link til /betingelser.
    juraTitel: "Legal",
    juraLink: "Terms & Security",
  },

  // Juraside-chrome (DRAFT-banner og navigation).
  // ⚠️ DET ER IKKE JURA-TEKST. Selve juraen kommer ordret fra pakken via
  // lib/uk/jura.js; de her fire strenge er sidens ramme, og de staar i
  // UNDTAGET i scripts/verify-uk-copy.mjs fordi copy-filen ikke daekker
  // juraside. De maa gerne omformuleres; jura-teksten maa ikke.
  jura: {
    tilbage: "All terms & policies",
    draftTitel: "Draft — pending legal review",
    draftBrod:
    ...
    todoLabel: "Still to be completed before publication:",
    // Jura-pakkens note 11: "Add a visible Report a problem route/contact for
    // Private Jobs". Overskriften er notens egen ordlyd; selve indholdet er
    // Private Job Terms §12, hentet derfra - se app/uk/report-a-problem.
    rapporter: "Report a problem",
    rapporterLink: "Read the full Private Job Terms",
    // Hub-siden. "Documents" er pakkens egen overskrift i /terms.
    dokumenter: "Documents",
    tilbageForside: "← Back to the homepage",
    // Cookie-politikkens §3 kalder den selv "Cookie Settings".
    cookieValg: "Cookie settings",
  },

  // ── 404 ──────────────────────────────────────────────────────────────────
  //
  // ⚠️ DEN FINDES FORDI EN UKENDT STI UNDER /uk RAMTE DEN DANSKE 404.
  // Rodlayoutet er dansk, og uden en not-found under /uk faldt fx
  // getbirdly.co.uk/legal ned paa "Siden blev ikke fundet" med dansk title og
  // dansk chrome — maalt i produktion 10-09-2026. Ikke et doedt link (intet
  // peger derhen), men en dansk fejlside paa et britisk domaene ser skaevt ud
  // for en der klikker rundt, og Clearhaus skal netop klikke rundt.
  //
  // ⚠️ FIRE STRENGE, INGEN MARKETING. Det er en fejlside, ikke en
  // salgsflade: den siger hvad der skete og peger tilbage. Copy-filen daekker
  // ikke 404 overhovedet, saa de staar i UNDTAGET i verify-uk-copy.mjs med
  // netop den grund — samme kategori som juraside-rammen og FAQ-foldeknappen.
  //
  // ⚠️ EGNE NOEGLENAVNE MED "fejl"-PRAEFIKS. Undtagelseslisten slaar op paa
  // det SIDSTE noeglesegment, saa en generisk noegle som `titel` her ville
  // fritage hver `titel` i hele ordbogen. Praefikset holder undtagelsen smal.
  fejl404: {
    fejlTitel: "Page not found",
    fejlBrod: "The page you are looking for does not exist, or it has moved.",
    fejlForside: "Go to the homepage",
    fejlJura: "All terms & policies",
  },
  ...
  meta: {
    ogBeskrivelse:
      `Birdly finds relevant public cleaning work across the UK and sends the right matches straight to your phone. ${TRIAL_DAYS} days free.`,
    ogSite: "Birdly",
  },
