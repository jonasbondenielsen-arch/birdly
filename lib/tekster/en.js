...
export const en = {
  ...
  // UDELADT frem for at få en sætning jeg selv har skrevet. Fem er ude:
  ...
  //   · "Where does the public contract data come from?"
  //        Filens svar åbner "For England, Birdly uses…" — men Jonas rettede
  //        09-09-2026 "across England" til "across the UK", fordi de 12 regioner
  //        dækker Skotland/Wales/NI. At lade sidens EGEN kildeforklaring sige
  //        "For England" ville modsige funnelen tre klik væk. Teksten ligger klar
  //        i filen; den mangler en geografi-afklaring, ikke en oversættelse.
  //
