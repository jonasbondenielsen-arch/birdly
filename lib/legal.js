...
// ⚠️ UDLEDT AF NØGLERNE, IKKE SKREVET I HÅNDEN (15-09-2026).
// Her stod et regex der kun dækkede PROEVE-familien. Da [VARSEL_DAGE] blev
// tilføjet til ERSTATNINGER, matchede regexen den ikke, substitutionen skete
// aldrig, og dobbeltværnet nedenfor væltede builden med "uerstattet
// pladsholder". Værnet virkede — regexen var bare et sted til at glemme.
// Nu kan en nøgle ikke tilføjes uden også at blive erstattet.
const PLADSHOLDER_RE = new RegExp(
  Object.keys(ERSTATNINGER)
    .map((k) => k.replace(/[.*+?^${}()|[\]\\]/g, (t) => "\\" + t))
    .join("|"),
  "g"
);
