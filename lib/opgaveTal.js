...
export async function hentOpgaveTal() {
  ...
  try {
    ...
    // ⚠️ Valideres på `bydbare` — det felt baren FAKTISK viser. Den tjekkede før
    // `i_alt`, som blev fjernet fra Edge Function'en da branchetallene røg; så
    // returnerede den null for alt, og fallbacken skjulte baren på hele sitet uden
    // en eneste fejl i loggen. Valider altid på det felt der bruges.
