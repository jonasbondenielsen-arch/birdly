...
export const GARANTI_LINK = "/handelsbetingelser#3-abonnement-pris-og-opsigelse";

export const GARANTI = {
  // ⚠️ TO FORSKELLIGE TING, OG DE MÅ ALDRIG SMELTE SAMMEN (06-09-2026):
  //   · PRØVEPERIODEN er TRIAL_DAYS dage (7 fra 14-09-2026). Den er gratis, og
  //     der trækkes 0 kr. Tallet interpoleres — skriv det ALDRIG som tekst her.
  ...
  // nævner prøvelængden, og de 60 står i `praecis` lige under, hver gang.
  overskrift: `${TRIAL_DAYS} dage gratis. Ingen relevante match? Så betaler du ikke.`,
