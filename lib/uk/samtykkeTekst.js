...
export const SAMTYKKE_EN = {
  ...
  //
  // ⚠️ FIRE KATEGORIER, I POLITIKKENS EGEN RÆKKEFØLGE. Banneret viste tre,
  // mens §4 beskrev fire — altså lovede politikken et valg der ikke fandtes.
  // Rettet 10-09-2026. Rækkefølgen her er ligegyldig; den kommer fra
  // KATEGORIER i lib/samtykke.js, hvor `funktionel` står som nummer to
  // ligesom i §4.
  kategorier: {
    noedvendige: {
      navn: "Necessary",
    ...
    funktionel: {
      navn: "Functional",
      tekst: "Optional preferences not strictly necessary.",
    },
    statistik: {
      navn: "Analytics",
