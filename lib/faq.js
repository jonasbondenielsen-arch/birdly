...
// Frisbii-planen (fast prøve, træk dagen efter). Beløb interpoleres fra
...
const KONVERTERING = [
  ...
  },
  {
    ...
    // ⚠️ "DAGEN EFTER" ER IKKE ET GÆT. Prøven er fast på begge Frisbii-planer
...
// ⚠️ SEKS SYNLIGE, RESTEN FOLDET (06-09-2026). Elleve åbne spørgsmål gjorde
// FAQ'en til sidens højeste sektion og skubbede den afsluttende CTA langt ned.
// De seks herunder er de FAKTISKE købstvivl; resten er detaljer man leder efter,
// ikke noget der står mellem kunden og et klik.
//
// ⚠️ RESTEN SLETTES IKKE. Svarene bliver stående i HTML'en bag en "Se alle
// spørgsmål"-knap — de er husets eneste sted med den fulde forklaring, og de
// skal blive ved med at kunne crawles.
const SALG_SYNLIGE = [
  "Hvilke opgaver finder Birdly?",
  "Er Birdly også til små virksomheder?",
  "Skal jeg selv søge efter opgaver?",
...
export const FAQ_SALG_TOP = FAQ_SALG.filter((f) => SALG_SYNLIGE.includes(f.sp));
export const FAQ_SALG_REST = FAQ_SALG.filter((f) => !SALG_SYNLIGE.includes(f.sp));
