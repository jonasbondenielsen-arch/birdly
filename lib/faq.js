...
export const FAQ = [
  ...
  // tre rettes.
  {
    ...
    svar:
      "Birdly finder både offentlige og private opgaver. Du vælger selv fag, område og de typer opgaver, du er interesseret i. Når vi finder et match, får du besked.",
  },
  {
    top: true,
    sp: "Skal jeg selv lede efter opgaver?",
    svar:
      "Nej. Birdly holder øje og sender dig besked, når noget relevant dukker op.",
  },
  {
    top: true,
    sp: "Skal jeg logge ind hver dag?",
    svar:
      "Nej. Relevante opgaver kommer direkte på SMS og mail.",
  },
  {
    top: true,
    sp: "Kan jeg vælge private opgaver fra?",
    svar:
      "Ja. Du bestemmer selv, hvilke typer opgaver du vil modtage. Private opgaver slår du fra på din opgaveside under \"Rediger\".",
  },
  {
    top: true,
    sp: "Hvad koster det?",
