...
export const MARKEDER = {
  ...
  GB: {
    ...
    //
    // ⚠️ TÆNDT 13-09-2026, OG BEVISET ER CRON-TIDSPUNKTERNE. Ikke "den er
    // deployet" og ikke "flaget er sat" — men at rækkerne er skrevet af sig
    // selv, på klokkeslæt, uden at nogen kørte noget i hånden:
    //     2026-09-12T11:30  ×20 nye GB-udbud
    //     2026-09-13T11:30  ×2
    // plus 16:30-kørslen 11-09. Cron'en fyrer 11:30 og 16:30 UTC, så bjælkens
    // "2× a day" er sand om GB på samme måde som om DK.
    //
    // ⚠️ HVER PAASTAND ER TJEKKET FOR SIG, ikke kun tallene:
    //   "2× dagligt"            → cron-tidspunkterne ovenfor
    //   "nye de seneste 7 dage" → aegte, ingesten koerer loebende
    //   "aaben frist"           → 338 lige nu, og tallet falder og stiger
    // Det var praecis dem der ville vaere usande paa et frossent backfill.
    dataLever: true,
    ...
    domaener: [
      ...
      // ⚠️ .uk VIDERESTILLER TIL .co.uk — DEN SERVERER IKKE SITET.
      // Begge navne er koebt, men kun eet skal vaere adressen: to domaener der
      // begge svarer 200 med samme indhold er duplikeret indhold, og et
      // canonical-tag alene er en henstilling, ikke en omdirigering.
      // Databasen siger allerede det samme — market_domains har enabled=false
      // paa netop de her to (migration 0144). Flaget her er kodens udgave af
      // den beslutning, saa proxy'en kan handle paa den.
      { host: "getbirdly.uk", primaer: false, viderestil: true },
      { host: "www.getbirdly.uk", primaer: false, viderestil: true },
    ],
  },
};
