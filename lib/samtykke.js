...
export const KATEGORIER = [
  ...
  {
    // ⚠️ KUN GB INDTIL VIDERE - OG DET ER EN BESLUTNING, IKKE EN HALV LOESNING.
    //
    // Begge cookiepolitikker beskriver FIRE kategorier. Banneret har hidtil
    // vist TRE, saa begge politikker har lovet et valg der ikke fandtes. Den
    // danske siger det endda direkte: "beder vi dig i vores cookie-banner om
    // samtykke til funktionelle, statistiske og markedsfoeringscookies."
    //
    // Den britiske uoverensstemmelse er rettet her. Den DANSKE er IKKE, fordi
    // det ville aendre samtykke-mekanikken paa et live site med betalende
    // kunder - det er Jonas' beslutning, ikke en sidegevinst ved en
    // UK-opgave. Teksten nedenfor er allerede den danske politiks egen
    // ordlyd, saa den dag beslutningen falder, er rettelsen at slette
    // `markeder`-linjen. Intet andet.
    //
    // ⚠️ INGEN VERSION-BUMP. Et bump ville bede HVER dansk besoegende om
    // samtykke igen for en kategori de ikke faar vist. `maa()` svarer nej til
    // en kategori der ikke er sagt ja til, saa et gammelt valg er
    // fail-closed af sig selv.
    id: "funktionel",
    navn: "Funktionelle",
    tekst: "Vi indsamler oplysninger om dine foretrukne indstillinger og valg, så vi kan vise dig den version af hjemmesiden, der passer til dine præferencer. Kræver samtykke.",
    markeder: ["GB"],
  },
  {
    id: "statistik",
...
const INTET = { noedvendige: true, funktionel: false, statistik: false, marketing: false };
